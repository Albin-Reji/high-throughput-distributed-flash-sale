...
@SpringBootTest
@DisplayName("PaymentServiceApplication Context & Configuration Tests")
class PaymentServiceApplicationTests {
    ...
    @Test
    @DisplayName("server.port should be 8085")
    void shouldHavePort8085Configured() {
        String port = environment.getProperty("server.port");
        assertThat(port).isEqualTo("8085");
    }
